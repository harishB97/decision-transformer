...
class GPT2Model(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        # config.n_ctx changed to config.n_position in new version, refer -> https://github.com/huggingface/transformers/pull/14165
    ...
    @add_code_sample_docstrings(
        processor_class=_TOKENIZER_FOR_DOC, # changed tokenizer_class to processor_class
        checkpoint="gpt2",
